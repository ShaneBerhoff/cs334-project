...
def main(full=True, batch=32, workers=4):
    model = torch.load(util.from_base_path("/Data/models/mnv3tl-small-tune/mnv3tl-small-e51.pt"))
    model = mnv3tl.MobileNetV3TL(full=False, path=util.from_base_path("/Data/models/mnv3tl-small-tune/mnv3tl-small-e51.pt"))
